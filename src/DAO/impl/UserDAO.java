...
public class UserDAO  extends AbstractDAO<UserModel> implements IUserDAO {
	...
	public Long save(UserModel userModel) {
		String sql  = "INSERT INTO user(fullname,avatar,username,password,address,phone,createdate,role,wallet) VALUES(?,?,?,?,?,?,?,?,?) ";
		return insert(sql, userModel.getFullname(),  userModel.getAvatar(), userModel.getUsername(), userModel.getPassword(), userModel.getAddress(),userModel.getPhone(), userModel.getCreatedate(),  userModel.getRole(),userModel.getWallet());
	}
	@Override
	public void updateWallet(UserModel userModel) {
		String sql = "UPDATE user SET wallet = ?  WHERE id =?"; 
		  insert(sql,userModel.getWallet(), userModel.getId() );
