         ...
         <div class="user-data m-b-30">
             ...
             <div class="filters m-b-45">
                 ...
                 <div class="rs-select2--dark rs-select2--sm rs-select2--border">
                     ...
                     <a  href="#addEmployeeModal" class="" data-toggle="modal"  style="float: right; ">
				...
				<div style="display: flex">
				   <div style="width: 50%; padding: 16px">	
					...
					<div class="form-group" style="display: flex; flex-direction: column">
						<label>Role</label>
						<select class="selected-default" name="role">
                                <option selected="" value="user"  selected="selected">User</option>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form name="delete" method="post" action ="<c:url value="/admin/user?action=delete " />  ">
				...
				<div class="modal-body">		
			    	<span>Id người dùng:</span><input type="text" value="" name="id" />			
					<p>Bạn có chắc mún xóa người dùng này</p>
