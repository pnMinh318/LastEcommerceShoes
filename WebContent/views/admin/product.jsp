				...
				<div style="display: flex">
				   <div style="width: 50%; padding: 16px">	
					  ...
					  <div style="width: 50%;padding: 16px">	
						...
						<select class="selected-default" name="category">s
                                <option value="1" selected="selected">Giày nam</option>
						...
						<select class="selected-default" name="promotion">
                                <option value="10%" selected="selected">Khuyến mãi 1</option>
                                <option value="20%">Khuyến mãi 2</option>
                                  <option value="30%">Khuyến mãi 3</option>
                                <option value="40%">Khuyến mãi 4</option>
                                  <option value="50%">Khuyến mãi 5</option>
                            </select>                   
					   </div>		
					</div>		
				</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form method="post" action="  <c:url value="/admin/product?action=edit" />" name="edit" anctype="multipart/form-data">
				...
				<div style="display: flex">
				   <div style="width: 50%; padding: 16px">	
					...
					<div class="form-group" style="display: flex; flex-direction: column">
						...
						<select class="selected-default" name="category">
                                <option value="1" selected="selected" >Giày nam</option>
                                <option value="2">Giày nữ</option>
                                <option value="3">Giày trẻ em</option>
				...
				<div class="modal-footer">
					<input type="button" class="btn btn-default" data-dismiss="modal" value="Hủy">
					<input type="submit" class="btn btn-success" value="Chỉnh sữa">
				</div>
			</form>
		</div>
	</div>		
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<form name="delete" method="post" action =" <c:url value="/admin/product?action=delete " />  ">
				...
				<div class="modal-body">		
			    	<span>Id sản phẩm:</span><input type="text" value="" name="id" />			
					<p>Bạn có chắc mún xóa nó ?</p>	
				</div>
				<div class="modal-footer">
					<input type="button" class="btn btn-default" data-dismiss="modal" value="Hủy">
 ...
 <script type="text/javascript">
		 $(document).ready(function(){
			 $("#editEmployeeModal").on('show.bs.modal', function(e) {
			      ...
			      $(e.currentTarget).find('img[name="thumbnail"]').val(thumbnail);
