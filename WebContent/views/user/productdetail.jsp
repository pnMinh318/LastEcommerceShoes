...
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"> 
<title>HOME | Chi tiết sản phẩm</title>
</head>
<body>
<section>
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					...
					<div class="recommended_items"><!--recommended_items-->
						<h2 class="title text-center">Mặt hàng gợi ý cho bạn</h2>
										...
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													...
													<a href="<c:url value="/cart?action=add&&id=${item.id}"/>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm vào giỏ</a>
												</div>
